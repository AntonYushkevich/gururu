...
function inputChange({value}) {
    ...
    if (!value.length) {
        ...
        document.querySelector('.about__submit').classList.toggle('about__submit_success', false);
...
function handleSubmitClick(e) {
    ...
    if (inputValue.match(regEmail)) {
        inputEl.blur();
        inputValue = '';
        document.querySelector('.about__submit').classList.toggle('about__submit_success', true);
        return document.querySelector('.about__submit').src = setImage('success')
        //return submit
    }
    document.querySelector('.about__submit').src = setImage('arrow-right_error');
